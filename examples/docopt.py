...
def docopt(doc, argv=None, help_message=True, version=None, options_first=False):
    ...
    match_user_input(tree_heads, usage_dic)

    print(usage_dic)
    return usage_dic

def match_user_input(tree_heads, usage_dic):
    args = sys.argv[1:]
    index = 0
    dic_entry = dict()
